...
---
- Room number: **28021**2
- Check-in date (dd/MM/yyyy): **223/09/2019**2
- Check-out date (dd/MM/yyyy): **226/09/2019**2
- Reservation: Room 8021, check-in: 23/09/2019, check-out: 26/09/2019, 3 nights

- Enter data to update the reservation:
- Check-in date (dd/MM/yyyy): **224/09/2020**2
- Check-out date (dd/MM/yyyy): **222/09/2020**2
- Error in reservation: Check-out date must be after check-in date